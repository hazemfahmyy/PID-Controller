...
int main ()
{
  ...
  **/
  ...
  pid_throttle.Init(0.25, 0.0, 0.12, 1, -1);
  //double P_s{0.1}, I_s{0.2}, D_s{0.3}, dp_s{1.0}, di_s{1.0}, dd_s{1.0};
  //double P_th, I_th, D_th, dp_th, di_th, dd_th;
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          /**if (error_steer < best_error){
            best_error = error_steer;
            dp_s *= 1.1;
          	di_s *= 1.1;
          	dd_s *= 1.1;}
          else{
          ...
          //pid_steer.UpdatePID(P_s, I_s, D_s)
//           error_steer = 0;
...
//           // Compute control to apply
          ...
          //P_s, dp_s = pid_steer.Twiddle(pid_steer->P, 1);
          //pid_steer::P = P_s
